      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-[#0d1321]/90 backdrop-blur-md border-b border-[rgba(197,160,89,0.2)]">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          <div className="flex items-center gap-4">
            ...
            <span className="px-3 py-1 bg-[rgba(197,160,89,0.2)] text-[#C5A059] rounded-full text-xs font-semibold">INSTITUTIONAL</span>
          </div>
          <div className="flex gap-4">
            <Link 
              href="/"
              className="px-5 py-2 text-gray-400 hover:text-white transition-colors text-sm font-semibold"
            >
              ← Back to Dashboard
            </Link>
            <a 
              href="https://calendly.com/goldbackbond/30min?month=2026-03"
              target="_blank"
